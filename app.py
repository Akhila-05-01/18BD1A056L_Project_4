...
account_sid='ACa11770075611486e5a18f0b9a8ec456c'
auth_token='66c1591c023cdb5b8d1c8231c2cab273'
...
def login_registration_dtls():
    ...
    if travel_pass < 30 and request.method == 'POST':
        status = 'CONFIRMED'
        client.messages.create(to="whatsapp:+919381211696",from_="whatsapp:+14155238886",
                               body = "Hello" + " " + full_name + " " + "Your Travel Form" + " " + source_dt + " " + "To" + " " +
                               destination_dt + " " +"Has" + " " + status + " " + "On" + " " + date + " " + ",Safe Journey")
        ...
        client.messages.create(to="whatsapp:+919381211696",from_="whatsapp:+14155238886",
                               body = "Hello" + " " + full_name + " " + "Your Travel Form" + " " + source_dt + " " + "To" + " " +
                               destination_dt + " " +
                               "Has" + " " + status + " " + "On" + " " + date + " " + ",Safe Journey")
        return render_template('user_registration_dtls.html', var=full_name, var1=email_id,
                               var3=source_st, var4=source_dt, var5=destination_st, var6=destination_dt,
                               var7=phone_number, var8=date, var9=status)
